...
contract('Exchange', ([deployer, feeAccount, user1, user2]) => {
    ...
    describe('depositing ether', async () => {
        ...
        it('emits a deposit event', async () => {
            ...
            event.balance.toString().should.equal(amount.toString(), "value is corret");
        });
    });
    ...
    describe('withdrawing ether', async () => {
        ...
        describe('success', async () => {
            ...
            it('emits a withdraw event', async () => {
                ...
                event.user.should.equal(user1, "user address is correct");
                event.amount.toString().should.equal(amount.toString(), 'amount is correct');
                event.balance.toString().should.equal('0', "value is corret");
            });
        });
    ...
    describe('order actions', async () => {
        beforeEach(async () => {
            ...
            // user1 makes an order to buy tokens w/ Ether
        ...
        describe('filling orders', async () => {
            ...
            describe('success', async () => {
                ...
                it('executes trade and charges fees', async () => {
                    ...
                    balance.toString().should.equal(tokens(0.99).toString(), 'user2 tokens deducted with fee');
            ...
            describe('failure', async () => {
                ...
                it('rejects alredy-filled orders', async () => {
